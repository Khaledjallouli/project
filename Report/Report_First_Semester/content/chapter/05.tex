...
\subsubsection{Results using Stochastic Gradient Descent Optimizer }
...
\end{figure}
\subsubsection{Make Predictions and Evaluate Models using Quality Criteria } % Is not in the evaluation chap ?
